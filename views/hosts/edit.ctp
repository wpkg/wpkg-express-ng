...
<div class="inputwrap"><label for="HostEnabled" title="<?php echo TOOLTIP_HOST_ENABLED; ?>">Enabled:</label><?php echo $form->input('enabled', array('label' => false, 'div' => false, 'type' => 'checkbox')) ?></div>
