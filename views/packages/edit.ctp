...
<div class="inputwrap"><label for="PackageEnabled" title="<?php echo TOOLTIP_PACKAGE_ENABLED; ?>">Enabled:</label><?php echo $form->input('enabled', array('label' => false, 'div' => false, 'type' => 'checkbox')) ?></div>
