...
<h2>Adding Package Action for '<?php echo $html->link($pkgName, array('controller'=>'packages', 'action'=>'view', $pkgId)); ?>'</h2><hr class="hbar" />
<?php echo $form->create("PackageAction", array("url" => "/packages/add/action/$pkgId")); ?>
...
<?php echo $form->hidden('position', array('value' => '0')); ?>
