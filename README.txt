...
wpkgExpress-ng © 2013 Probesys - Based on wpkgExpress by Brian White © 2009
...
===============
 ...
 - Start the wpkgExpress installation process by navigating to (replacing 'yourserver' with your hostname and 'someplace' with the directory containing wpkgExpress): http://yourserver/someplace (You'll be redirected to http://yourserver/someplace/installer)
